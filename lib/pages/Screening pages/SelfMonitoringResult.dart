...
class SelfMonitoringResult extends StatelessWidget {
  List<Steps> steps = [
    Steps(
        id: '1',
        title: 'Stay six feet away from others',
        description:
        'You should avoid crowds of people and social gatherings, particularly indoors. You should also stay six feet apart from anyone you don’t live with. You should especially avoid anyone who’s showing symptoms.\n\nPhysical distancing can also help you avoid catching COVID‑19 from someone who isn’t showing any symptoms.'),
    Steps(
        id: '2',
    ...
    Steps(
        ...
        description:
        'Watch for COVID‑19 symptoms such as fever, cough, and difficulty breathing.\n\nIf anything changes, you can take the questionnaire again.'),
  ];
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Image(
                      image: AssetImage('lib/images/social-distancing.png'),
