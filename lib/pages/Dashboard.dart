        ...
        children: [
          ...
          Flexible(
            child: Row(
              children: [
                _buildStatsCard(
                    'Total Cases', '587704', ColorBrightOrange),
                _buildStatsCard('New Cases', '3037', ColorBrightYellow),
              ],
            ),
          ),
          Flexible(
            child: Row(
              children: [
                _buildStatsCard('Total Recoveries', '535207', ColorBrightGreen),
                _buildStatsCard('New Recoveries', '170', ColorBrightBlue),
                _buildStatsCard('Total Deaths', '12423', ColorBrightRed)
              ],
            ),
          ),
        ],
